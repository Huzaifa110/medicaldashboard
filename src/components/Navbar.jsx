...
const Navbar = () => {
  return (
    <nav className="fixed top-0 left-0 w-full h-[60px] bg-white shadow-lg flex items-center px-0 m-0">
      <div className="max-w-[1920px] w-full mx-0 flex justify-between items-center h-full">
        ...
        <div className="flex-1 mx-4 relative hidden md:block">
          <input
            type="text"
            placeholder="Search..."
            className="w-full md:w-[200px] h-[41px] p-1 bg-[#F4F4F4] border border-white rounded-tl-md focus:outline-none"
          />
        </div>
